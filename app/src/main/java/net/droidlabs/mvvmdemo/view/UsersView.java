  ...
  public View.OnClickListener onButtonClick() {
    return new View.OnClickListener() {
      ...
      public void onClick(View v) {
        usersViewModel.addUser(getStringFromEditText(binding.usersViewFirstname),
            getStringFromEditText(binding.usersViewLastname));
      }
    };
  }
  ...
  public LongClickHandler<UserViewModel> longClickHandler() {
    return new LongClickHandler<UserViewModel>() {
      ...
      public void onLongClick(UserViewModel user) {
        Toast.makeText(UsersView.this, "LONG CLICK: " + user.getFirstName() + " " + user.getLastName(),
